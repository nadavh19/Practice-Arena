...
export function CurrentSessionSummary({ session }: CurrentSessionSummaryProps) {
  return (
    <SurfaceCard className="music-accent-panel overflow-hidden border-violet-950/70 p-0 shadow-[0_28px_80px_-48px_rgba(46,16,101,0.85)]">
      <div className="grid gap-6 p-6 sm:p-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:justify-self-end">
          ...
          <div className="rounded-2xl border border-amber-300/30 bg-amber-300/15 p-4 text-amber-50 shadow-[inset_0_1px_0_rgba(255,255,255,0.12)] backdrop-blur">
            <p className="text-xs font-semibold uppercase tracking-[0.14em] text-amber-100">Time</p>
